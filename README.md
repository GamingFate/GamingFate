...
🎓 B.Tech Electrical & Computer Engineering (2026)  
...
### AI / Machine Learning
TensorFlow, Keras, Scikit-Learn, OpenCV, YOLOv8, Computer Vision

### Data Science
NumPy, Pandas, Matplotlib

### Tools
Git, Flask, MATLAB, Power BI, Excel
...
End-to-end autonomous driving system using NVIDIA Behavioral Cloning CNN for steering angle prediction.

🔗 Repository:
https://github.com/GamingFate/AI-Self-Driving-Car-Steering-Angle-Prediction

---

### 🏍️ Smart Helmet Detection using YOLOv8
Real-time helmet detection system for traffic safety monitoring using Computer Vision.

🔗 Repository:
https://github.com/GamingFate/Smart-Helmet-violation-detection

---

### 🌦️ Sensorless Real-Time Weather Monitoring
ESP32-based weather monitoring system using OpenWeatherMap API and ThingSpeak cloud integration.
...
📧 namanbhasin2014@gmail.com

💼 LinkedIn:
https://www.linkedin.com/in/naman-bhasin-59042a251

💻 GitHub:
https://github.com/GamingFate
